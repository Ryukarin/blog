<template><h2 id="目录结构" tabindex="-1"><a class="header-anchor" href="#目录结构" aria-hidden="true">#</a> 目录结构</h2>
...
<p><img src="@source/project/Linux/Linux_basic/assets/dir.png" alt="dir" loading="lazy"></p>
...
<h3 id="根目录" tabindex="-1"><a class="header-anchor" href="#根目录" aria-hidden="true">#</a> / 根目录</h3>
...
<h3 id="usr-目录" tabindex="-1"><a class="header-anchor" href="#usr-目录" aria-hidden="true">#</a> /usr 目录</h3>
...
<h3 id="var-目录" tabindex="-1"><a class="header-anchor" href="#var-目录" aria-hidden="true">#</a> /var 目录</h3>
...
<h3 id="硬件设备名称" tabindex="-1"><a class="header-anchor" href="#硬件设备名称" aria-hidden="true">#</a> 硬件设备名称</h3>
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@localhost ~<span class="token punctuation">]</span><span class="token comment"># man dir_colors</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><p>注意，有些 Linux 发行版单独使用 <code>ls</code> 命令，无法显示出带有不同颜色的文件和目录，此时就需要使用 <code>ls --color=auto</code> 命令，明确令其使用颜色来区分文件类型。</p>
<p>在此基础上，如果不想每次使用 <code>ls</code> 命令时，都显式附带 <code>--color=auto</code>，可以执行如下命令:</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@localhost ~<span class="token punctuation">]</span><span class="token comment"># alias ls = 'ls --color=auto'</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><p>通过给 <code>ls --color==auto</code> 这个整体设置一个别名 <code>ls</code>，这样当后续使用 <code>ls</code> 命令时，就等同于执行 <code>ls --color=auto</code> 命令。</p>
...
总用量 <span class="token number">620</span>
-rwxrw-r--    <span class="token number">1</span> root root    <span class="token number">493</span> <span class="token number">4</span>月  <span class="token number">27</span> <span class="token number">14</span>:29 deploy.sh
drwxr-xr-x   <span class="token number">16</span> root root   <span class="token number">4096</span> <span class="token number">5</span>月   <span class="token number">4</span> <span class="token number">16</span>:52 dist
drwxr-xr-x    <span class="token number">7</span> root root   <span class="token number">4096</span> <span class="token number">5</span>月   <span class="token number">4</span> 09:10 docs
drwxr-xr-x <span class="token number">1002</span> root root  <span class="token number">36864</span> <span class="token number">5</span>月   <span class="token number">4</span> 09:16 node_modules
-rw-r--r--    <span class="token number">1</span> root root    <span class="token number">386</span> <span class="token number">5</span>月   <span class="token number">4</span> 08:16 package.json
-rw-r--r--    <span class="token number">1</span> root root <span class="token number">577009</span> <span class="token number">5</span>月   <span class="token number">4</span> 08:17 package-lock.json
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br></div></div><h3 id="命名规则" tabindex="-1"><a class="header-anchor" href="#命名规则" aria-hidden="true">#</a> 命名规则</h3>
<ul>
...
<h3 id="不同字符对应的文件类型" tabindex="-1"><a class="header-anchor" href="#不同字符对应的文件类型" aria-hidden="true">#</a> 不同字符对应的文件类型</h3>
...
<h2 id="linux-挂载" tabindex="-1"><a class="header-anchor" href="#linux-挂载" aria-hidden="true">#</a> Linux 挂载</h2>
