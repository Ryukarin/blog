<template><h2 id="学习-linux-的注意事项" tabindex="-1"><a class="header-anchor" href="#学习-linux-的注意事项" aria-hidden="true">#</a> 学习 Linux 的注意事项</h2>
<p>对于初学者来说几个容易混淆的问题，便于让大家对 Linux 有一个初步了解。</p>
<h3 id="linux-严格区分大小写" tabindex="-1"><a class="header-anchor" href="#linux-严格区分大小写" aria-hidden="true">#</a> Linux 严格区分大小写</h3>
<p>Linux 是严格区分大小写的，这一点和 Windows 不一样，所以操作时要注意区分大小写的不同，包括文件名和目录名、命令、命令选项、配置文件设置选项等。</p>
<h3 id="linux-中所有内容以文件形式保存-包括硬件设备" tabindex="-1"><a class="header-anchor" href="#linux-中所有内容以文件形式保存-包括硬件设备" aria-hidden="true">#</a> Linux 中所有内容以文件形式保存，包括硬件设备</h3>
...
<h3 id="linux-不靠扩展名区分文件类型" tabindex="-1"><a class="header-anchor" href="#linux-不靠扩展名区分文件类型" aria-hidden="true">#</a> Linux 不靠扩展名区分文件类型</h3>
...
<h3 id="linux-中所有的存储设备都必须在挂载之后才能使用" tabindex="-1"><a class="header-anchor" href="#linux-中所有的存储设备都必须在挂载之后才能使用" aria-hidden="true">#</a> Linux 中所有的存储设备都必须在挂载之后才能使用</h3>
...
<h3 id="windows-下的程序不能直接在-linux-中使用" tabindex="-1"><a class="header-anchor" href="#windows-下的程序不能直接在-linux-中使用" aria-hidden="true">#</a> Windows 下的程序不能直接在 Linux 中使用</h3>
...
<h2 id="服务器的管理和维护建议" tabindex="-1"><a class="header-anchor" href="#服务器的管理和维护建议" aria-hidden="true">#</a> 服务器的管理和维护建议</h2>
...
<h3 id="了解-linux-目录结构" tabindex="-1"><a class="header-anchor" href="#了解-linux-目录结构" aria-hidden="true">#</a> 了解 Linux 目录结构</h3>
...
<h3 id="远程服务器关机及重启的注意事项" tabindex="-1"><a class="header-anchor" href="#远程服务器关机及重启的注意事项" aria-hidden="true">#</a> 远程服务器关机及重启的注意事项</h3>
...
<h3 id="不要在服务器访问高峰运行高负载命令" tabindex="-1"><a class="header-anchor" href="#不要在服务器访问高峰运行高负载命令" aria-hidden="true">#</a> 不要在服务器访问高峰运行高负载命令</h3>
...
<h3 id="远程配置防火墙时不要把自己踢出服务器" tabindex="-1"><a class="header-anchor" href="#远程配置防火墙时不要把自己踢出服务器" aria-hidden="true">#</a> 远程配置防火墙时不要把自己踢出服务器</h3>
...
<h3 id="指定合理的密码规范并定期更新" tabindex="-1"><a class="header-anchor" href="#指定合理的密码规范并定期更新" aria-hidden="true">#</a> 指定合理的密码规范并定期更新</h3>
...
<h3 id="合理分配权限" tabindex="-1"><a class="header-anchor" href="#合理分配权限" aria-hidden="true">#</a> 合理分配权限</h3>
...
<h3 id="定期备份重要数据和日志" tabindex="-1"><a class="header-anchor" href="#定期备份重要数据和日志" aria-hidden="true">#</a> 定期备份重要数据和日志</h3>
<blockquote>
<p>没有备份的服务器，就是在作死！<br>
没有备份的服务器，就是在作死！<br>
没有备份的服务器，就是在作死！</p>
