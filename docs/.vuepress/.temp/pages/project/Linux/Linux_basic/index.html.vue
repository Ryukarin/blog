<template><h2 id="什么是操作系统" tabindex="-1"><a class="header-anchor" href="#什么是操作系统" aria-hidden="true">#</a> 什么是操作系统</h2>
...
<h2 id="从-unix-到-linux" tabindex="-1"><a class="header-anchor" href="#从-unix-到-linux" aria-hidden="true">#</a> 从 UNIX 到 Linux</h2>
...
<h3 id="unix-的坎坷历史" tabindex="-1"><a class="header-anchor" href="#unix-的坎坷历史" aria-hidden="true">#</a> UNIX 的坎坷历史</h3>
...
<h3 id="linux-的那些往事" tabindex="-1"><a class="header-anchor" href="#linux-的那些往事" aria-hidden="true">#</a> Linux 的那些往事</h3>
...
<h3 id="unix-与-linux-的关系" tabindex="-1"><a class="header-anchor" href="#unix-与-linux-的关系" aria-hidden="true">#</a> UNIX 与 Linux 的关系</h3>
...
<h2 id="unix-linux-系统结构" tabindex="-1"><a class="header-anchor" href="#unix-linux-系统结构" aria-hidden="true">#</a> UNIX/Linux 系统结构</h2>
...
<p><img src="@source/project/Linux/Linux_basic/assets/structure.jpg" alt="Structrure" loading="lazy"></p>
...
<h2 id="linux-的优势" tabindex="-1"><a class="header-anchor" href="#linux-的优势" aria-hidden="true">#</a> Linux 的优势</h2>
...
<h2 id="linux-的应用领域" tabindex="-1"><a class="header-anchor" href="#linux-的应用领域" aria-hidden="true">#</a> Linux 的应用领域</h2>
<p>Linux 似乎在我们平时的生活中很少看到，那么它应用在哪些领域呢？其实，在生活中随时随地都有 Linux 为我们服务着······</p>
<ol>
<li><strong>网站服务器</strong></li>
</ol>
<p>用事实说话！访问国际知名的 Netcraft 网站 <a href="http://www.inetcraf.com" target="_blank" rel="noopener noreferrer">http://www.inetcraf.com<ExternalLinkIcon/></a>，在“What's that site running?”的地址栏内输入想了解信息的网站地址，单击箭头图标即可搜索到相关信息。</p>
...
<h2 id="linux-的发行版本" tabindex="-1"><a class="header-anchor" href="#linux-的发行版本" aria-hidden="true">#</a> Linux 的发行版本</h2>
<p>Linux 的发行版说简单点就是将 Linux 内核与应用软件做一个打包。</p>
<div class="custom-container center">
<p><img src="@source/project/Linux/Linux_basic/assets/intro.jpg" alt="intro" loading="lazy"></p>
...
<h3 id="red-hat-linux" tabindex="-1"><a class="header-anchor" href="#red-hat-linux" aria-hidden="true">#</a> Red Hat Linux</h3>
...
<h3 id="ubuntu-linux" tabindex="-1"><a class="header-anchor" href="#ubuntu-linux" aria-hidden="true">#</a> Ubuntu Linux</h3>
...
<h3 id="suse-linux" tabindex="-1"><a class="header-anchor" href="#suse-linux" aria-hidden="true">#</a> SuSE Linux</h3>
...
<h3 id="gentoo-linux" tabindex="-1"><a class="header-anchor" href="#gentoo-linux" aria-hidden="true">#</a> Gentoo Linux</h3>
...
<h3 id="发行版选择" tabindex="-1"><a class="header-anchor" href="#发行版选择" aria-hidden="true">#</a> 发行版选择</h3>
