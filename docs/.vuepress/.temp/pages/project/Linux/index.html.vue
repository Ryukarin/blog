<template><h2 id="git-是什么" tabindex="-1"><a class="header-anchor" href="#git-是什么" aria-hidden="true">#</a> Git 是什么</h2>
...
<p><img src="@source/project/Linux/assets/dvcs.png" alt="dvcs" loading="lazy"></p>
<h2 id="git-的诞生" tabindex="-1"><a class="header-anchor" href="#git-的诞生" aria-hidden="true">#</a> Git 的诞生</h2>
...
<h2 id="gitub-是什么" tabindex="-1"><a class="header-anchor" href="#gitub-是什么" aria-hidden="true">#</a> Gitub 是什么</h2>
...
<div class="custom-container tip"><p class="custom-container-title">了解</p>
