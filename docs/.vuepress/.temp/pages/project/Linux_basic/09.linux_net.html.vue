...
<p><img src="@source/project/Linux_basic/assets/setup1.png" alt="setup1" loading="lazy"></p>
<p><strong>图10-1	<u>配置工具界面</u></strong></p>
</div>
<p>接下来就可以执行动作选择了。我们要配置 IP 地址，就选择“Decive configuration”，如图10-2 所示。</p>
<div class="custom-container center">
<p><img src="@source/project/Linux_basic/assets/setup2.png" alt="setup2" loading="lazy"></p>
...
<div class="custom-container center">
<p><img src="@source/project/Linux_basic/assets/setup3.png" alt="setup3" loading="lazy"></p>
<p><strong>图10-3	<u>选择设备</u></strong></p>
</div>
<p>接下来就会进入网络配置界面，如图10-4 所示。这时如果在“Use DHCP”选项上输入 “*”号（空格输入）。就会自动获取 IP 地址：取消“*”号，就会手工分配 IP 地址。</p>
<div class="custom-container center">
<p><img src="@source/project/Linux_basic/assets/setup4.png" alt="setup4" loading="lazy"></p>
